  ...
  return (
    <Section className="overflow-hidden" id="roadmap">
      <div className="container md:pb-10">
        ...
        <div className="relative grid md:grid-cols-2 md:gap-4 gap-6 md:pb-[7rem]">
          {roadmap.map((item) => {
            ...
            return (
              ...
              >
                ...
                "
                >
                  <div className="absolute top-0 left-0 justify-between max-w-[27rem] mb-8 md:mb-20">
                    <img
                      src={grid}
                      className="w-full"
                      width={550}
                  ...
                  <div className="relative z-1 pb-[5rem]">
        ...
        <div className="flex justify-center pt-[5rem]">
          <Button className="uppercase">Our Roadmap</Button>
        </div>
      </div>
    </Section>
  );
